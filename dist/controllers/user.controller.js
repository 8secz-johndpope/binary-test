...
/**
 * the following schema is used for the response body
 */
...
tslib_1.__decorate([
    rest_1.post('/users/login', {
        responses: {
            '200': {
                description: 'Login API used to authorize the user and generate JWT',
                content: {
                    'application/json': {
                        schema: {
                            type: 'object',
...
tslib_1.__decorate([
    rest_1.post('/users/signup', {
        responses: {
            '200': {
                description: 'Signup API used to register user based on the default loopback User Schema',
                content: {
                    'application/json': {
                        schema: {
